...
def get_unetvgg2d(image_rows, image_cols):
    inputs = Input((image_rows, image_cols, 1))
    conv11 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv13')(inputs)
    conv12 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv2', use_bias='false')(conv11)
