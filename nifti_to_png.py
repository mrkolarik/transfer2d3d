...
def convert_masks_vol_data():  # Function to load nifti files and convert them to normalized Pngs for later use
    data_path = './data/masks_vol/'
    resampled_path = './resampled/masks_vol/'
    spline_order = 0
    i = 0
    print('-' * 30)
    print('Creating training images...')
